...
export const CLINICS = [
  {
    ...
    specialty: 'Sản phụ khoa',
    address: '13 Cao Thắng, Phường Bàn Cờ, Q.3, TP.HCM',
    avatar: '🏥',
    rating: 4.8,
    reviewCount: 210,
    price: '150.000đ',
    description: 'Phòng khám chuyên sâu về Sản Phụ Khoa, kế hoạch hóa gia đình, hiếm muộn KHHGĐ với đội ngũ PGS.TS.BS hàng đầu.',
    images: ['🏥','🏨','🏗️'],
    services: ['Khám Sản Phụ Khoa', 'Siêu âm thai', 'Kế hoạch hóa gia đình', 'Điều trị hiếm muộn'],
  ...
  },
  {
    ...
    specialty: 'Nhi khoa',
    address: '105/10 Nguyễn Thị Tú, Phường Bình Hưng Hòa B, Q.Bình Tân, TP.HCM',
    avatar: '👶',
    rating: 4.6,
    reviewCount: 135,
    price: '120.000đ',
    description: 'Phòng khám Nhi chuyên khoa uy tín, khám và điều trị các bệnh lý trẻ em từ sơ sinh đến 15 tuổi.',
    images: ['👶','🏥','🏨'],
    services: ['Khám Nhi tổng quát', 'Tiêm chủng', 'Tư vấn dinh dưỡng trẻ em', 'Khám sức khỏe định kỳ'],
  ...
  },
  {
    ...
    reviewCount: 98,
    price: '100.000đ',
    description: 'Trung tâm y tế cộng đồng cung cấp dịch vụ chăm sóc sức khỏe toàn diện, giá cả hợp lý cho mọi đối tượng.',
    images: ['🏪','🏥','🏨'],
    services: ['Khám đa khoa', 'Xét nghiệm', 'Chụp X-quang', 'Tư vấn sức khỏe'],
    workingHours: 'Thứ 2 – Thứ 6: 07:30 – 16:30',
    phone: '028 3855 xxxx',
  },
  {
    id: 4,
    ...
    reviewCount: 324,
    price: '200.000đ',
    description: 'Phòng khám da liễu cao cấp, chuyên điều trị mụn, nám, lão hóa và các bệnh lý da liễu bằng công nghệ hiện đại.',
    images: ['✨','🏥','💆'],
    services: ['Khám Da liễu', 'Điều trị mụn', 'Trị nám', 'Chống lão hóa', 'Laser thẩm mỹ'],
    workingHours: 'Thứ 2 – Thứ 7: 09:00 – 19:00',
    phone: '028 7300 xxxx',
  },
  {
    id: 5,
    name: 'Phòng khám Tai Mũi Họng Bác sĩ Tuấn',
    specialty: 'Tai mũi họng',
    address: '45 Lê Văn Sỹ, P.13, Q.3, TP.HCM',
    avatar: '👂',
    rating: 4.7,
    reviewCount: 187,
    price: '130.000đ',
    description: 'Phòng khám chuyên Tai Mũi Họng với bác sĩ nhiều năm kinh nghiệm, trang bị máy móc hiện đại.',
    images: ['👂','🏥','🏨'],
    services: ['Khám Tai Mũi Họng', 'Nội soi tai mũi họng', 'Điều trị viêm xoang', 'Phẫu thuật nhỏ'],
    workingHours: 'Thứ 2 – Thứ 6: 08:00 – 17:00, Thứ 7: 08:00 – 12:00',
    phone: '028 3845 xxxx',
  },
  {
    id: 6,
    name: 'Phòng khám Răng Hàm Mặt Nha Khoa Việt',
    ...
    reviewCount: 256,
    price: '100.000đ',
    description: 'Nha khoa uy tín với dịch vụ toàn diện từ khám tổng quát đến niềng răng, cấy implant.',
    images: ['🦷','🏥','🏨'],
    services: ['Khám răng tổng quát', 'Nhổ răng', 'Trám răng', 'Niềng răng', 'Cấy Implant', 'Tẩy trắng răng'],
    workingHours: 'Thứ 2 – Chủ nhật: 08:00 – 20:00',
    phone: '028 3829 xxxx',
  },
]